(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                function AuthGuard(authService, alertifyService, router) {
            ...
            var MemberDetailResolver = /** @class */ (function () {
                ...
                MemberDetailResolver.prototype.resolve = function (route) {
                    ...
                    return this.userService.getUser(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
                        _this.alertifyService.error('Problem retriving data');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MemberEditResolver = /** @class */ (function () {
                function MemberEditResolver(userService, authService, router, alertifyService) {
                    this.userService = userService;
                    this.authService = authService;
                    this.router = router;
                    this.alertifyService = alertifyService;
                ...
                MemberEditResolver.prototype.resolve = function (route) {
                    ...
                    return this.userService.getUser(this.authService.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
                        _this.alertifyService.error('Problem retriving your data');
                        _this.router.navigate(['/members']);
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(null); // returning observable of null
                    }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.login = function (model) {
                    var _this = this;
                    return this.http.post(this.baseUrl + 'login', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
                        var user = res;
                        if (user) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MemberDetailComponent = /** @class */ (function () {
                function MemberDetailComponent(userService, alertifyService, route) {
                    this.userService = userService;
                    this.alertifyService = alertifyService;
                    this.route = route;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MemberEditComponent = /** @class */ (function () {
                function MemberEditComponent(route, alertifyService, userService, authService) {
                    this.route = route;
                    this.alertifyService = alertifyService;
                    this.userService = userService;
                    this.authService = authService;
                ...
                MemberEditComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.data.subscribe(function (data) {
                        _this.user = data['user'];
                        _this.authService.currentPhotoUrl.subscribe(function (photoUrl) {
                ...
                MemberEditComponent.prototype.updateUser = function () {
                    ...
                    this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
                        _this.alertifyService.success('Profile update successfully');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MemberListComponent = /** @class */ (function () {
                function MemberListComponent(userService, alertifySercice, route) {
                    this.userService = userService;
                ...
                MemberListComponent.prototype.resetFileters = function () {
                    this.userParams.gender = this.user.gender === 'female' ? 'male' : 'female';
                    this.userParams.minAge = 18;
                    this.userParams.maxAge = 99;
                    this.loadUsers();
                ...
                MemberListComponent.prototype.loadUsers = function () {
                    ...
                    }, function (error) { _this.alertifySercice.error(error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhotoEditorComponent = /** @class */ (function () {
                ...
                PhotoEditorComponent.prototype.deletePhoto = function (id) {
                    var _this = this;
                    this.alertifyService.confirm('Are you sure you want to delete this photo ?', function () {
                        _this.userService.deletePhoto(_this.authService.decodedToken.nameid, id).subscribe(function () {
                            _this.photos.splice(_this.photos.findIndex(function (p) { return p.id === id; }), 1); // splice will delete from photos array
                            _this.alertifyService.success('Photo has been deleted');
                        }, function (error) {
                            _this.alertifyService.error(error);
                        });
                    });
            ...
            var NavComponent = /** @class */ (function () {
                ...
                NavComponent.prototype.login = function () {
                    ...
                    this.authService.login(this.model)
                        ...
                        return err.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["scan"])(function (retryCount) {
                            retryCount += 1;
                            if (retryCount < 6) {
                                _this.alertify.warning('Retrying attempt....' + retryCount);
                                return retryCount;
                            }
                            else {
                                throw (err);
                    ...
                    }, function () { _this.router.navigate(['/members']); });
                };
